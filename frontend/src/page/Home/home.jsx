...
const CARD_ICONS = [IconBox, IconWallet, IconMoney, IconBag, IconCheck, IconStore, IconGrid]
...
const MAIS_VENDIDO_SEMANA = [
  ...
  { id: 17, nome: 'Smartwatch Fitness', descricao: 'Monitor cardíaco', preco: 499.99, imagem: CardSmart },
